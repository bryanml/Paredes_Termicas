...
integer, parameter :: N1 = 200, N2 = 200, N = N1+N2, kb = 1
real(kind=8), allocatable :: r(:,:), v(:,:), f(:,:), fl(:,:), eps(:,:), mass(:), ecut(:,:)
real(kind=8), parameter :: rho = 0.4, thermal_skin = 1.2, rc2 = 2.5*2.5
integer , allocatable :: tipe(:)
real(kind=8), parameter ::  gamma = 0.5, sigma = 1.0
