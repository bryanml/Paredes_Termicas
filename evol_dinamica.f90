...
temp_z_promedio(:) = 0
call temp_prof(0,ultimo_tiempo)
...
do i=1,N_evo !!Empiezo a medir
	...
	call temp_prof(1,ultimo_tiempo)
	call temp_prof(2,ultimo_tiempo)
	call temp_prof(3,ultimo_tiempo)
	call temp_prof(4,ultimo_tiempo)
	write(unit=10,fmt=*) E_cin1/N, E_pot/N, E_mec/N,ultimo_tiempo
	call test
...
call temp_prof(5,ultimo_tiempo)
